/**
* @file Switch.h
* @brief Fan,Heater,Icemachineのスイッチクラスを定義する
* @author yokota0717
* @date 2018.10.9
*/
...
/**
* @brief Fan,Heater,Icemachineのスイッチクラス
* @details 
*/
class Switch : public GameObject {
	...
	Switch();
	bool Initialize(Vec2& pos, std::vector<std::shared_ptr<GameObject>> target);
	void Update();
	void Render2D();
	bool Finalize();
...
public:
	...
	static Switch::SP Create(Vec2& pos, std::vector<std::shared_ptr<GameObject>> targets, bool flag = true);
